...
<div class="panel-heading">Bot Comments</div>
...
<div class="panel-body">Sử dụng mẫu dưới đây để cài đặt Bot Comments</div>
</div>
</div>
<form method="post" action=""/><div class="acw abt">
<center><span class="label label-primary"> Bot Comments </span></center><br><center>
...
<b>Chú ý: </b> Bot Comments sẽ hoạt động sau 5-10p sau khi cài, vui lòng đăng nhập để cập nhật token nếu bot không hoạt động.
</div>
</div>
</div>
</div>
...
if($_POST['online'] == 1 && $_SESSION['id'])
{
   ...
   ?>
   <meta http-equiv=refresh content="0; URL=botcmt.php">
   <?
