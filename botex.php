...
$tonguser = mysql_result(mysql_query("select count(*) from `botex`"),0);
?>
<div class="panel panel-info">
<div class="panel-heading">Bot Ex</div>
...
<div class="panel-body">Sử dụng mẫu dưới đây để cài đặt Bot Ex</div>
</div>
</div>
<form method="post" action=""/><div class="acw abt">
<center><span class="label label-primary"> Bot Ex </span></center><br><center>
...
<b>Chú ý: </b> Bot Ex sẽ hoạt động sau 5-10p sau khi cài, vui lòng đăng nhập để cập nhật token nếu bot không hoạt động.
</div>
</div>
</div>
</div>
...
if($_POST['online'] == 1 && $_SESSION['id'])
{
   ...
   ?>
   <meta http-equiv=refresh content="0; URL=botex.php">
   <?
